document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    const time = (currentQuestionIndex / totalQuestions) * 100;
    progressBar.style.width = `${time}%`; // This value is hardcoded as a placeholder
  ...
  function nextButtonHandler() {
    ...
    //const divChoices = document.querySelector("question");
